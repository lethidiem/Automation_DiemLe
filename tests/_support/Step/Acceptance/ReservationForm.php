...
class ReservationForm extends \AcceptanceTester
{
    /**
     * @param $ID
     * @param $number
     ...
     */
     public function creatReservation($reservationArray = array())
     {
         $I=$this;
         $I->waitForElementVisible(PageReservation::$tableID,30);
         $I->fillField(PageReservation::$tableID, $reservationArray['ID']);
         $I->waitForElementVisible(PageReservation::$numberPerson,30);
         $I->fillField(PageReservation::$numberPerson,$reservationArray['number']);
         $I->waitForElementVisible(PageReservation::$date,30);
         $I->fillField(PageReservation::$date,$reservationArray['date']);
         $I->waitForElementVisible(PageReservation::$description,30);
         if(isset($reservation['des']))
            {
                $I->fillField(AddNew::$description, $reservationArray['des']);
            }
         $I->waitForElementVisible(PageReservation::$startTime,30);
         $I->fillField(PageReservation::$startTime,$reservationArray['time']);
     ...
     */
     public function clearData($reservationArray = array())
     {
         $I=$this;
         $I->waitForElementVisible(PageReservation::$tableID,30);
         $I->fillField(PageReservation::$tableID,$reservationArray['ID']);
     ...
     */
    public function edit($reservationArray = array())
    {
        $I=$this;
